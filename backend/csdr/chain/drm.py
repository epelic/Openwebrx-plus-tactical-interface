from csdr.chain.demodulator import BaseDemodulatorChain, FixedIfSampleRateChain, FixedAudioRateChain, HdAudio, MetaProvider, AudioServiceSelector, DialFrequencyReceiver
from pycsdr.modules import Convert, Writer
...
class Drm(BaseDemodulatorChain, FixedIfSampleRateChain, FixedAudioRateChain, HdAudio, MetaProvider, AudioServiceSelector, DialFrequencyReceiver):
    def __init__(self):
    ...
    def setAudioServiceId(self, serviceId: int) -> None:
        self.drmModule.setAudioServiceId(serviceId)
